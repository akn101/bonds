...
Cada leitura de recurso verifica acesso de Leitor ao cofre proprietário. Contactos não listados não são retornados por `fetch_resource`, e recursos anexados apenas a contactos não listados são filtrados.
