...
## In flight
- **PR naiba/bonds#266 (CardDAV coordinate preservation) is OPEN and unreviewed** — the one outstanding upstream item.
- The VPS still runs a custom image `bonds:0.22.2-akn-reports3`; moving to upstream main is parked until #266 lands (planned but not user-approved yet).

## Branches & PRs
- Upstream PRs: #259/#262/#263/#264 merged; #266 open.
...
## Next steps
1. Watch naiba/bonds#266; address review when it comes.
2. After #266 merges: propose the VPS move to upstream images (needs owner approval; mind the 127.0.0.1:8080 compose binding on the VPS).
3. Rebase any resumed branch onto upstream main first.
